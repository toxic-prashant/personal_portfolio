    ...
    return (
        <div style={{
            ...
            <div className="w-full flex items-center justify-center text-white">
                ...
                <a href="mailto:yadavprashant1016@gmail.com"><i class="fa-solid text-4xl fa-envelope"></i></a>
                </div>
                <div className="hover:bg-orange-400 border cursor-pointer px-3 py-4 w-14 h-14 rounded-full flex justify-center items-center bg-gray-700">
                <a href="https://github.com/toxic-prashant"><i class="fa-brands text-4xl fa-github"></i></a>
                </div>
                <div className="hover:bg-orange-400 border cursor-pointer px-3 py-4 w-14 h-14 rounded-full flex justify-center items-center bg-gray-700">
                <i class="fa-brands text-4xl fa-instagram"></i>
                </div>
                <div className="hover:bg-orange-400 border cursor-pointer px-3 py-4 w-14 h-14 rounded-full flex justify-center items-center bg-gray-700">
                <a href="https://www.linkedin.com/in/prashant-yadav07/"><i class="fa-brands text-4xl fa-linkedin"></i></a>
                </div>
                </div>
                <br />
